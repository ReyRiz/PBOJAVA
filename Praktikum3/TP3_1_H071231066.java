...
public class TP3_1_H071231066 {
    public static void main(String[] args){
        Scanner input = new Scanner(System.in);
        System.out.print("Welcome to game!\nPress '1' to play!\n>> ");
        int pilihan = input.nextInt();
        boolean menu = true;
        SungJinWoo player1 = null;
        ChaHaeIn player2 = null;
        if (pilihan == 1){
            do { 
            ...
            switch (pilihan){
                case 1:
                    menu = true;
                    System.out.print("U Choose Sung Jin Woo! are u want edit ur status or no? (yes/no)\n>> ");
                    String edit = input.next();
                    if (edit.equals("yes")){
                        System.out.println("Edit Status of Sung Jin Woo Character : ");
                        System.out.print("HP : ");
                        ...
                        player1 = new SungJinWoo(hp, mp, level, str);
                    } else {
                        player1 = new SungJinWoo();
                    }
                    break;
                case 2:
                    menu = true;
                    System.out.print("U Choose Cha Hae In! are u want edit ur status or no? (yes/no)\n>> ");
                    edit = input.next();
                    if (edit.equals("yes")){
                        System.out.println("Edit Status of Cha Hae In Character : ");
                        System.out.print("HP : ");
                        int hp = input.nextInt();
                        System.out.print("MP : ");
                        int mp = input.nextInt();
                        ...
                        System.out.print("Strength : ");
                        int str = input.nextInt();
                        player2 = new ChaHaeIn(hp, mp, level, str);
                    } else {
                        player2 = new ChaHaeIn();
                    }
                    break;
                case 3:
                    System.out.println("=================== GAME INFO (HOW TO PLAY) INDO SAJA BAHASANYA ========================");
                    System.out.println("Player : \nDisini sistem player adalah kita memilih salah satu dari 2 player, Sung Jin Woo atau");
                    System.out.println("Cha Hae In, lalu sistem dari player juga setiap dia naik level maka HP dan MP nya akan dipulihkan");
...
class SungJinWoo{
    Scanner input = new Scanner(System.in);
    final private String nama = "Sung Jin Woo";
    String job = "";
    int hp, mp, level, str;
    int escapeStone = 0;
    ...
    SungJinWoo(int hp, int mp, int level, int str){
        this.hp = hp;
        this.mp = mp;
        this.level = level;
        this.str = str;
...
class ChaHaeIn{
    Scanner input = new Scanner(System.in);
    final private String nama = "Cha Hae In";
    int hp, mp, level, str;
    int escapeStone = 0;
    ...
    ChaHaeIn(int hp, int mp, int level, int str){
        this.hp = hp;
        this.mp = mp;
        this.level = level;
        this.str = str;
