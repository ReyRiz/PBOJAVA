...
public class TP3 {
    ...
    static String Validasi(int bulan, int tanggal, int tahun){
        ...
        /* Disini saya sekalian memvalidasi tanggal dan tahunnya agar satu kali kerja saja
         * Dibawah ini merupakan switch case bulan yang case 1-12, nah seperti bulan pada umumnya
         * Ketika bulan nya 1 maka ditulis "Januari", dan juga ada hal yang diperhatikan tanggal
         * memang bulannya sudah sesuai tapi kalau tanggalnya lebih dari 31? maka sebenarnya tidak valid, makanya method ini digunakan untuk validasi
         * Begitu seterusnya sampai bulan 12, di bulan 2 khusunya Februari ada kasus dimana setiap 4 tahun sekali atau 
         * tahun kabisat akan ada tanggal 29 pada kalender, namun jika bukan tahun kabisat maka februari hanya sampai 28 saja
         * Begitu seterusnya.
         * System.exit(1) artinya langsung mengeluarkan program atau memberhentikan program
         */
        switch (bulan){
            case 1:
